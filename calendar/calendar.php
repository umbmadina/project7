                        ...
                        <div class="modal fade" id="add-category" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header text-center border-bottom-0 d-block">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title mt-2">Add event</h4>
                                    </div>
                                    <div class="modal-body p-4">
                                        <form role="form">
                                            ...
                                            <input class="form-control form-white" type="date" name="date" value="">
                                            <label class="control-label">Time</label>
                                            <input class="form-control form-white" type="time" name="date" value="">
                                            <input type="checkbox" name="checkbox" value="" style = "margin-right: 5px; margin-top: 10px">  Surprise party!
